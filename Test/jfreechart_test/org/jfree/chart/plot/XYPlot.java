...
public class XYPlot extends Plot implements ValueAxisPlot, Pannable, Zoomable,
    ...
    public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor,
        ...
        if(isOutlineVisible()) {
        	...
        	g2.fillRect((int)dataArea.getMinX(), (int)dataArea.getMinY(), 8, 8);
        	g2.fillRect((int) (dataArea.getMaxX() - 8), (int)dataArea.getMinY(), 8, 8);
        	g2.fillRect((int)dataArea.getMinX(), (int) (dataArea.getMaxY() - 8), 8, 8);
        	g2.fillRect((int) (dataArea.getMaxX() - 8), ((int)dataArea.getMaxY() -8), 8, 8);
        }
