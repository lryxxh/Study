 ...
 * @since 1.0.13
 */
public class CustomCrosshair extends Crosshair implements Cloneable, PublicCloneable, Serializable {

    /** Flag controlling visibility. */
    private boolean visible;

    /** The CustomCrosshair value. */
    private double value;

    /** The paint for the CustomCrosshair line. */
    private transient Paint paint;

    /** The stroke for the CustomCrosshair line. */
    private transient Stroke stroke;

    /**
     * A flag that controls whether or not the CustomCrosshair has a label
     * visible.
     */
...
//    private RectangleAnchor labelAnchor;
    ...
    /**
     * Creates a new CustomCrosshair with value 0.0.
     */
    ...
    /**
     * Creates a new CustomCrosshair with the specified value.
     *
     * @param value  the value.
     */
    public CustomCrosshair(double value) {
       this(value, Color.black, new BasicStroke(1.0f));
    }

    /**
     * Creates a new CustomCrosshair value with the specified value and line style.
     *
     * @param value  the value.
     * @param paint  the line paint (<code>null</code> not permitted).
     * @param stroke  the line stroke (<code>null</code> not permitted).
     */
    public CustomCrosshair(double value, Paint paint, Stroke stroke) {
        if (paint == null) {
...
//        this.labelAnchor = RectangleAnchor.BOTTOM_LEFT;
    ...
    /**
     * Returns the flag that indicates whether or not the CustomCrosshair is
     * currently visible.
     *
     * @return A boolean.
     *
    ...
    /**
     * Sets the flag that controls the visibility of the CustomCrosshair and sends
    ...
    /**
     * Returns the CustomCrosshair value.
     *
     * @return The CustomCrosshair value.
     *
     * @see #setValue(double)
     */
    ...
    /**
     * Sets the CustomCrosshair value and sends a property change event with the name
    ...
    /**
     * Returns the paint for the CustomCrosshair line.
     *
    ...
    /**
     * Sets the paint for the CustomCrosshair line and sends a property change event
    ...
    /**
     * Returns the stroke for the CustomCrosshair line.
     *
    ...
    /**
     * Sets the stroke for the CustomCrosshair line and sends a property change event
     ...
     * CustomCrosshair and sends a property change event (with the name
    ...
    /**
     * Returns the CustomCrosshair label generator.
     *
     * @return The label CustomCrosshair generator (never <code>null</code>).
     *
     * @see #setLabelGenerator(org.jfree.chart.labels.CustomCrosshairLabelGenerator)
     */
    ...
    /**
     * Sets the CustomCrosshair label generator and sends a property change event
...
//        this.pcs.firePropertyChange("labelAnchor", old, anchor);
    ...
    /**
     * Tests this CustomCrosshair for equality with an arbitrary object.
     *
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CustomCrosshair)) {
            return false;
        }
        CustomCrosshair that = (CustomCrosshair) obj;
