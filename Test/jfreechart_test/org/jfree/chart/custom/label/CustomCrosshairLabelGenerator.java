package org.jfree.chart.custom.label;
/* ===========================================================
 ...
 * @since 1.0.13
 */
public class CustomCrosshairLabelGenerator implements CrosshairLabelGenerator,
        Serializable {
     ...
     */
    public CustomCrosshairLabelGenerator() {
     ...
     *     permitted).
     */
    public CustomCrosshairLabelGenerator(String labelTemplate,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CustomCrosshairLabelGenerator)) {
            return false;
        }
        CustomCrosshairLabelGenerator that
                = (CustomCrosshairLabelGenerator) obj;
