 ...
 */
public class CustomLegendGraphic extends AbstractBlock
    ...
    public void draw(Graphics2D g2, Rectangle2D area) {
        ...
        if (shape != null) {
        	...
        	double x = shape.getBounds().getX() + location.getX();
        	double y = shape.getBounds().getY() + location.getY();
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CustomLegendGraphic)) {
            return false;
        }
        CustomLegendGraphic that = (CustomLegendGraphic) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
    	CustomLegendGraphic clone = (CustomLegendGraphic) super.clone();
