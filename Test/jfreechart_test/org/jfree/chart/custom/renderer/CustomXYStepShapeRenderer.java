...
public class CustomXYStepShapeRenderer extends CustomXYLineShapeRenderer{
	 /** For serialization. */
     ...
     */
    public CustomXYStepShapeRenderer() {
        this(null, null);
    }
     ...
     */
    public CustomXYStepShapeRenderer(XYToolTipGenerator toolTipGenerator,
...
//        setURLGenerator(urlGenerator);
    ...
    public void drawItem(Graphics2D g2,
        ...
        if (domainAxis instanceof CustomDateAxis) {
        	transX1 = ((CustomDateAxis) domainAxis).valueToJava2DCustom(x1, dataArea, xAxisLocation, series);
        }
        ...
        if (pass == 0 && item > 0) {
            ...
            if (domainAxis instanceof CustomDateAxis) {
            	transX0 = ((CustomDateAxis) domainAxis).valueToJava2DCustom(x0, dataArea,
                        xAxisLocation, series);
            }
    ...
    public boolean equals(Object obj) {
        ...
        CustomXYStepShapeRenderer that = (CustomXYStepShapeRenderer) obj;
