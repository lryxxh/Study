 ...
 *
 */
public class CustomXYLineShapeRenderer extends XYLineAndShapeRenderer
	...
	public CustomXYLineShapeRenderer() {
		super(true, false);
	}
	
	public CustomXYLineShapeRenderer(boolean lines, boolean shapes) {
		super(lines, shapes);
		setProperty();
	}
...
//        System.out.println(series + "--------------"+new Date((long)x1).toLocaleString());
    ...
    protected void drawPrimaryLine(XYItemRendererState state,
        ...
        double transX1 = domainAxis.valueToJava2D(x1, dataArea, xAxisLocation);
        if (domainAxis instanceof CustomDateAxis) {
        	transX0 = ((CustomDateAxis)domainAxis).valueToJava2DCustom(x0, dataArea, xAxisLocation, series);
        	transX1 = ((CustomDateAxis)domainAxis).valueToJava2DCustom(x1, dataArea, xAxisLocation,series);
