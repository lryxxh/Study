...
public class CanvasArcTest extends JPanel {
	MyCanvas canvas;
	...
	class SliderListener implements ChangeListener {
		public void stateChanged(ChangeEvent e) {
			...
			canvas.revalidate();
			canvas.repaint();
			System.out.println("x" + canvas.x + "   y" + canvas.y + "   w" + canvas.w + "  h" + canvas.h + "  starta"
					+ canvas.startAngle + "  extent" + canvas.extent);
			System.out.println(canvas.arc.getStartPoint());
			System.out.println(canvas.arc.getEndPoint());
		}
	}

	public static void main(String[] a) {
		JFrame f = new JFrame();
		f.getContentPane().add(new CanvasArcTest());
