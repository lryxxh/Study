 ...
 */
public class CombineFixTableLayout extends ScrollPaneLayout {

    /** 序列ID */
    private static final long serialVersionUID = -301288702480810903L;
    ...
    public void layoutContainer(Container parent) {
        ...
        hsbR.width = availR.width + vpbInsets.left + rowHeadR.width + vpbInsets.right;
        hsbR.x = rowHeadR.x;
        /*
