...
//
//import com.kedong.hmi.service.common.DBID;
//import com.kedong.hmi.service.locator.LocatorService;
//
//import agency.message.base.socket.SocketInfo;
//import agency.message.locater.Locator;
//import agency.message.locater.LocatorResult;
//
//import socketmanager.MessageSendReceive;
//
///**
...
//     */
//    private final HashMap<String,BlockingQueue<Runnable>> workQueueMap = new HashMap<String, BlockingQueue<Runnable>>();
//
//    /**
...
//     */
//    
//    public <T> Future<T> submit(Callable<T> task, String dbid, MessageSendReceive sendReceive) {
//    	  if (task == null) throw new NullPointerException();
//          RunnableFuture<T> ftask = newTaskFor(task);
//          execute(ftask, dbid, sendReceive);
//          return ftask;
//    }
//    
//    public void execute(Runnable command, String dbid, MessageSendReceive sendReceive) {
//    	String key = "";
//    	DBID dbidObj = new DBID(dbid);
//    	String domain = dbidObj.getDomain();
//    	String contextName = dbidObj.getCtxName();
//    	String appName = dbidObj.getAppName();
//    	String serviceName = dbidObj.getServerName();
//    	String serverName = dbidObj.getServerName();
////    	LocatorResult locatorResult = LocatorService.locate(domain, contextName, appName, serviceName);
//		if (command == null)
//			throw new NullPointerException();
//		if (poolSize >= corePoolSize || !addIfUnderCorePoolSize(command,key)) {
//			if (runState == RUNNING && workQueueMap.get(key).offer(command)) {
//				if (runState != RUNNING || poolSize == 0)
//					ensureQueuedTaskHandled(command, key);
//			} else if (!addIfUnderMaximumPoolSize(command, key))
...
//     */
//    private Thread addThread(Runnable firstTask,String key) {
//        Worker w = new Worker(firstTask,key);
...
//     */
//    private boolean addIfUnderCorePoolSize(Runnable firstTask, String key) {
//        Thread t = null;
//        final ReentrantLock mainLock = this.mainLock;
//        mainLock.lock();
//        try {
//            if (poolSize < corePoolSize && runState == RUNNING)
//                t = addThread(firstTask, key);
//        } finally {
//            mainLock.unlock();
//        }
//        return t != null;
...
//     * @return true if successful
//     */
//    private boolean addIfUnderMaximumPoolSize(Runnable firstTask,String key) {
//        Thread t = null;
//        final ReentrantLock mainLock = this.mainLock;
//        mainLock.lock();
//        try {
...
//     */
//    private void ensureQueuedTaskHandled(Runnable command,String key) {
//        final ReentrantLock mainLock = this.mainLock;
//        mainLock.lock();
...
//        try {
//            int state = runState;
//            if (state != RUNNING && workQueueMap.get(key).remove(command))
//                reject = true;
//            else if (state < STOP &&
//                     poolSize < Math.max(corePoolSize, 1) &&
//                     !workQueueMap.get(key).isEmpty())
//                t = addThread(null, key);
//        } finally {
//            mainLock.unlock();
//        }
//        if (reject)
...
//
//        Worker(Runnable firstTask, String key) {
...
//     * allowed.
//     */
//    private boolean workerCanExit(String key) {
//        final ReentrantLock mainLock = this.mainLock;
//        mainLock.lock();
//        boolean canExit;
//        try {
...
//     * @param w the worker
//     */
//    void workerDone(Worker w,String key) {
//        final ReentrantLock mainLock = this.mainLock;
//        mainLock.lock();
//        try {
...
//     */
//    private void tryTerminate(String key) {
//        if (poolSize == 0) {
//            int state = runState;
...
//     */
//    public BlockingQueue<Runnable> getQueue(String key) {
//        return workQueueMap;
//    }
//
//    /**
