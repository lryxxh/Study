...
public class GCurveConvertFromStr {
	...
	public static final int DATA_FIELD_TYPE_FHL = 35;// 负荷率
	public static final int DATA_FIELD_TYPE_AVG_FH = 36;// 平均负荷
	public static final int DATA_FIELD_TYPE_INT_FHL = 37;// 整点负荷率
	public static final int DATA_FIELD_TYPE_AM_MAX = 38;// 上午最大值
	public static final int DATA_FIELD_TYPE_AM_MIN = 39;// 上午最小值
	public static final int DATA_FIELD_TYPE_PM_MAX = 40;// 下午最大值
	public static final int DATA_FIELD_TYPE_PM_MIN = 41;// 下午最小值
	public static final int DATA_FIELD_TYPE_NG_MAX = 42;// 晚上最大值
	public static final int DATA_FIELD_TYPE_NG_MIN = 43;// 晚上最小值
	public static final int DATA_FIELD_TYPE_INT_MAX = 44;// 整点最大值
	public static final int DATA_FIELD_TYPE_INT_MIN = 45;// 整点最小值
	public static final int DATA_FIELD_TYPE_AM_MAX_TIME = 46;// 上午最大值时间
	public static final int DATA_FIELD_TYPE_AM_MIN_TIME = 47;// 上午最小值时间
	public static final int DATA_FIELD_TYPE_PM_MAX_TIME = 48;// 下午最大值时间
	public static final int DATA_FIELD_TYPE_PM_MIN_TIME = 49;// 下午最小值时间
	public static final int DATA_FIELD_TYPE_NG_MAX_TIME = 50;// 晚上最大值时间
	public static final int DATA_FIELD_TYPE_NG_MIN_TIME = 51;// 晚上最小值时间
	public static final int DATA_FIELD_TYPE_INT_MAX_TIME = 52;// 整点最大值时间
	public static final int DATA_FIELD_TYPE_INT_MIN_TIME = 53;// 整点最小值时间
