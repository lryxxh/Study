 ...
 * @author xuzhiqi
 */
public class DMailReceived extends javax.swing.JPanel {
	...
	public DMailReceived(String title, String directory, String suffix) {
		this.suffix = suffix;
		this.title = title;
	...
	// if ("day".equals(type)
	// && map.get("时间").toString()
	// .startsWith(DateUtils.getDate(type))) {
	// l.add(map);
	// }
	// if ("week".equals(type)
	// && map.get("时间").toString()
	...
	public void addActionListener() {
		...
		jButton2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (fileNames.size() <= 0) {
					JOptionPane.showMessageDialog(DMailReceived.this,
							"请选择要删除的邮件!");
					return;
				}
				...
				hideColumn();
				JOptionPane.showMessageDialog(DMailReceived.this, "已成功删除");
			}
		});
		// 上一页
