 ...
 * @author xuzhiqi
 */
public class DMailSent extends javax.swing.JPanel {

	private static final long serialVersionUID = 1L;
	DefaultTableModel model = null;
	Object title_table[] = new String[] { "选择", "邮件主题", "发件人", "收件人", "发送时间",
			"附件大小", "FileName", "attachmentName", "content" };
	Vector vector = null;
	String directory = "/";
	private int index = 1;
	...
	public DMailSent(String title, String directory, String suffix) {
		this.suffix = suffix;
		this.title = title;
	...
	public void addActionListener() {
		...
		jButton2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (fileNames.size() <= 0) {
					JOptionPane.showMessageDialog(DMailSent.this, "请选择要删除的邮件!");
					return;
				}
				...
				hideColumn();
				JOptionPane.showMessageDialog(DMailSent.this, "已成功删除");
			}
		});
		// 上一页
		jButton3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (index <= 1) {
					JOptionPane.showMessageDialog(DMailSent.this, "当前已是第一页！");
					return;
				}
				index--;
				display(getPage());
		...
		jButton4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (list.size() <= (index * pageCount)) {
					JOptionPane.showMessageDialog(DMailSent.this, "当前已是最后一页！");
					return;
				}
				index++;
				display(getPage());
