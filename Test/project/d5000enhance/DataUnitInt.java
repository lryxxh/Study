 ...
 * 
 */
public class DataUnitInt implements DataUnitInterface {
	...
	public int getDataLength() {
		return StaticFinals.INT_LENGTH;
	}
	...
	public int compareTo(DataUnitInterface dataUnitInterface) {
		...
		if (dataUnitInterface.getClass().getName().equals(getClass().getName())) {
			flag = (int) (this.data - ((DataUnitInt)dataUnitInterface).data);
		}
		return flag;
	}
