 ...
 * 
 */
public class DataUnitByteArray implements DataUnitInterface {
	 ...
	 * @param longData
	 */
	public DataUnitByteArray(byte[] data) {
		this.data = data;
	}
	...
	public int compareTo(DataUnitInterface dataUnitInterface) {
		...
		if (dataUnitInterface.getClass().getName().equals(getClass().getName())) {
			flag = this.data.length - ((DataUnitByteArray)dataUnitInterface).data.length;
		}
		return flag;
	}
