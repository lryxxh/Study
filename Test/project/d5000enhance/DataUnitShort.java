 ...
 * 
 */
public class DataUnitShort implements DataUnitInterface {
	 ...
	 * @param longData
	 */
	public DataUnitShort(short data) {
		this.data = data;
	}
	...
	public int getDataLength() {
		return StaticFinals.SHORT_LENGTH;
	}
	...
	public void setLongData(long longData) {
		this.data = (short) longData;
	}

	@Override
	public short getDataType() {
		return StaticFinals.SHORT;
	}
	...
	public int compareTo(DataUnitInterface dataUnitInterface) {
		...
		if (dataUnitInterface.getClass().getName().equals(getClass().getName())) {
			flag = this.data - ((DataUnitShort)dataUnitInterface).data;
		}
		return flag;
	}
